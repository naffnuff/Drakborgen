...
void Setup::createTiles(TileDeck& tiles)
{
	...
	createTile<Room>(tiles, "003", Direction::East, Direction::South, Direction::West);
	createTile<Room>(tiles, "004", Direction::North, Direction::East, Direction::South);
	...
	createTile<Room>(tiles, "008", Direction::North, Direction::South);
	...
	createTile<Room>(tiles, "021", Direction::South, Direction::East);
	...
	createTile<Room>(tiles, "024", Direction::North, Direction::East, Direction::South, Direction::West);
	createTile<Room>(tiles, "025", Direction::South);
	...
	createTile<Room>(tiles, "028", Direction::East, Direction::South, Direction::West);
	...
	createTile<Room>(tiles, "036", Direction::North, Direction::South);
	...
	createTile<Room>(tiles, "040", Direction::East, Direction::South);
	createTile<SplitRoom>(tiles, "041");
	createTile<Room>(tiles, "042", Direction::North, Direction::West);
	...
	createTile<Room>(tiles, "051", Direction::South, Direction::West);
	createTile<Room>(tiles, "052", Direction::North, Direction::South, Direction::West);
	...
	createTile<Room>(tiles, "061", Direction::North, Direction::East, Direction::South, Direction::West);
	...
	createTile<Room>(tiles, "075", Direction::North, Direction::South, Direction::West);
	createTile<Room>(tiles, "076", Direction::South, Direction::West);
	...
	createTile<Room>(tiles, "094", Direction::North, Direction::East, Direction::South);
	...
	createTile<Room>(tiles, "100", Direction::North, Direction::East, Direction::South, Direction::West);
