...
void Game::run()
{
	...
	idleHeroes.push_back(Hero("rohan", "Riddar Rohan", 15));
	idleHeroes.push_back(Hero("sigeir", "Sigeir Skarpyxe", 14));
	idleHeroes.push_back(Hero("aelfric", "Aelfric Brunkåpa", 10));
	idleHeroes.push_back(Hero("bardhor", "Bardhor Bågman", 8));
